...
- HOMELAB (`index.html`): Hardware, Software, Netzwerk & Sicherheit
...
- AR/3D-Modelle vorbereitet (`ar-models/`, optional über HOMELAB Seite)
...
- Seiten: `index.html`, `index.html`, `support.html`, `faq.html`, `kontakt.html`
